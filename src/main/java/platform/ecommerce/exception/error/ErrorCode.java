...
public enum ErrorCode {
    ...
    NOT_ENOUGH_STOCK("ITEM_002", "상품의 재고가 부족합니다."),
    ITEM_OPTION_REQUIRED("ITEM_003", "최소 하나 이상의 상품 옵션이 필요합니다."),

    //CART
    CART_INVALID_QUANTITY("CART_001", "수량은 0보다 커야 합니다."),
    CART_ITEM_NOT_FOUND("CART_002", "해당 장바구니 항목이 존재하지 않습니다."),
    CART_ACCESS_DENIED("CART_003", "해당 장바구니 항목에 대한 권한이 없습니다."),
    CART_INVALID_ITEM("CART_004", "유효하지 않은 상품입니다."),
    CART_INVALID_OPTION("CART_005", "해당 옵션의 재고가 부족합니다."),

    //ORDER
    ORDER_NOT_FOUND("ORDER_001", "주문을 찾을 수 없습니다."),
    ORDER_ALREADY_CANCELLED("ORDER_002", "이미 취소된 주문입니다."),
    ORDER_INVALID_STATE("ORDER_003", "주문 상태가 올바르지 않습니다."),
    ORDER_CANNOT_CANCEL("ORDER_004", "배송 준비 중인 경우에만 주문 취소가 가능합니다."),
    ORDER_CANNOT_CHANGE_ADDRESS("ORDER_005", "배송 준비 중인 경우에만 주소 변경이 가능합니다."),
    ORDER_ALREADY_SHIPPED("ORDER_006", "이미 배송된 상품은 취소할 수 없습니다."),
    ORDER_CANNOT_MODIFY("ORDER_007", "배송 중이거나 완료된 주문은 수정할 수 없습니다."),
    ...
    ORDER_INVALID_QUANTITY("ORDER_011", "주문 수량은 1 이상이어야 합니다."),
    ORDER_INVALID_PRICE("ORDER_012", "가격은 0 이상이어야 합니다."),

    //REVIEW
    REVIEW_NOT_FOUND("REVIEW_001", "해당 리뷰를 찾을 수 없습니다."),
    REVIEW_FORBIDDEN("REVIEW_002", "다른 회원이 작성한 리뷰는 수정할 수 없습니다."),
    REVIEW_REPLY_NOT_FOUND("REVIEW_003", "삭제할 관리자 답변이 존재하지 않습니다."),
    ...
    MEMBER_PASSWORD_BLANK("MEMBER_003", "비밀번호는 공백일 수 없습니다."),
